...
class Hero:
    ...
    def draw(self, surface_to_draw):
        collide_with_wall = collide_with(self.get_bbox(self.position), level1_map, wall_codes)
    ...
    def update(self, events):
        ...
        collide_with_wall_by_x = collide_with(self.get_bbox(new_pos_dx), level1_map, wall_codes)
        collide_with_wall_by_y = collide_with(self.get_bbox(new_pos_dy), level1_map, wall_codes)
