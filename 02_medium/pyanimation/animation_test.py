...
sprite_sheet = pygame.image.load("../Snake/images/rabbit.png")

TILE = 32

rabbit_animations = []
animations_seq_left = [1, 5, 9]
#animations_seq = [0, 4, 8,  5, 5, 5, 8, 0, 4, 6, 6, 6, 3, 3, 3, 5, 5, 5]
animations_seq = [6, 6, 2, 10, 6, 6, 7, 7, 5, 5, 1, 9, 5, 5, 4, 4]
current_phase = 0

for x in range(3):
    for y in range(4):
        rabit_sprite = sprite_sheet.subsurface(
            (0 + x * TILE, 6 + y * TILE, TILE, TILE)
        )
