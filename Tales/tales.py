...
text = 'Жил в метрополитене один интересный персонаж, его звали ' + name + '. ' + zhil_text +', около ' + str(random_year) + ' лет, ' + name + ' очень любил ' + sport + ' на своей станции, под названием ' + place + '. Но однажды когда начал '+ sport + ' пришел '+ adjective + ', откусил ему ногу и убежал с криками '+ tell + '. "Ух, '  + exclamation + '!" сказал ' + name + '.'
